...
def train(hyp):
    ...
    run.log(name='epoch count', value=(epoch - start_epoch + 1))
    run.log(name='the best_fitness', value=best_fitness[0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=8)  # 500200 batches at bs 16, 117263 COCO images = 273 epochs
    parser.add_argument('--batch-size', type=int, default=16)  # effective bs = batch_size * accumulate = 16 * 4 = 64
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-tiny-3cls.cfg', help='*.cfg path')
    parser.add_argument('--data', type=str, default='data/detect.data', help='*.data path')
    ...
    check_git_status()
    print(opt)
    print('Data folder:', opt.data_folder)
    print(os.listdir(opt.data_folder))
